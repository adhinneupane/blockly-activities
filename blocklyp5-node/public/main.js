...
function reload(){
    elem=document.getElementsByTagName('script').parentNode;
...
function runCode(){
        ...
        console.log("creattablewas",executable.tableCreated)
        console.log("show was",executable.showEnabled)
        console.log("slideshow was", executable.slideShow)
        checkConstraints();
