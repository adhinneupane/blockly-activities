function setup(){
  ...
  newRow.setString(column_names[1],""+firstrowentry);
   newRow.setString(column_names[2],""+secondrowentry);
   }
   function printTable()
  { for(let c=0;c<1;c++){
  ...
  { Total();
   ...
   newRow.setString(column_names[1],""+""+number_of_rows*firstrowentry);
   newRow.setString(column_names[2],""+secondrowentry*number_of_rows);
